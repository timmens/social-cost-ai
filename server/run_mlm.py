...
def main():
    ...
    model_args = ModelArguments(model_name_or_path="bert")
    ...
    for data_args in list_of_data_args:
        ...
        _data_sets.append(data)

    raw_data = DatasetDict()
    for _type in ["train", "test", "validate"]:
        raw_data[_type] = concatenate_datasets([data[_type] for data in _data_sets])

    # ==================================================================================
    # Load pretrained model and tokenize
    # ==================================================================================
    ...
    if training_args.do_train:
        ...
        column_names = raw_data["validation"].column_names
